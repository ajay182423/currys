import { Component, OnInit, ViewChild, ElementRef, OnDestroy, Input, SimpleChanges } from '@angular/core';
...
export class CallTranscriptComponent implements OnInit, OnDestroy {
