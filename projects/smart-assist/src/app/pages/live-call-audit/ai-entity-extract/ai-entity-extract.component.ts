...
import { EntityPopupComponent } from '../entityPopup/entity-popup.component';
...
@Component({
  selector: 'app-ai-entity-extract',
  templateUrl: './ai-entity-extract.component.html',
  styleUrls: ['./ai-entity-extract.component.scss']
})
export class AIEntityExtractComponent implements OnInit, OnDestroy {
