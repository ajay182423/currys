...
@Component({
  selector: 'app-call-wrap-up',
  templateUrl: './call-wrap-up.component.html',
  styleUrls: ['./call-wrap-up.component.scss']
})
export class CallWrapUpComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    const addButton = document.getElementById('cwu');
    if (addButton) {
      addButton.click();
    }
