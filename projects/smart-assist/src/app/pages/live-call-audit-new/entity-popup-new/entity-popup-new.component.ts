...
@Component({
  selector: 'app-entity-popup-new',
  templateUrl: './entity-popup-new.component.html',
  styleUrls: ['./entity-popup-new.component.scss']
})
export class EntityPopupNewComponent implements OnInit {
