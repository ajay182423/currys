...
@Component({
  selector: 'app-call-information-new',
  templateUrl: './call-information-new.component.html',
  styleUrls: ['./call-information-new.component.scss']
})
export class CallInformationNewComponent implements OnInit, OnDestroy {
